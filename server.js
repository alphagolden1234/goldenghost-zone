...
app.get('/api/health', (req, res) => res.json({ ok: true, service: 'golden-ghost', version: '37.0.0', port: PORT, publicIndex: fs.existsSync(INDEX_FILE), time: new Date().toISOString() }));
...
app.get('/healthz', (req, res) => {
  res.status(200).json({ ok: true, service: 'golden-ghost', version: '37.0.0', time: new Date().toISOString() });
});
